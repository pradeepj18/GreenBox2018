	...
	<%
		try {
			...
			if (session.getAttribute("login_id") == null) {
				...
				List<?> getTrialMember = getDAOList.getTrialMember(trial_id);
	%>
				...
				<ul id="slide-out" class="side-nav fixed leftside-navigation">
					...
					<li class="bold  "><a href="home.jsp"
						class="waves-effect waves-cyan"><i class="material-icons">apps</i>
							Dashboard</a></li>
					<li class="bold active"><a href="teamlist.jsp"
				...
				<div class="row">
					<div class="col s12 m8 offset-m2 l6 offset-l3"
						...
						<div class="center tittle ">
							<h5 style="color: white;">Select Player</h5>
							<div style="color: white">
								<i>Select first 6 member at a time for trial</i>
							</div>
						</div>
						<form onsubmit="return isvalidForm(this);"
							action="../AddTrialTeamPlayer" method="post">
							<input type="text" id="myInput" onkeyup="myTrialMember()" placeholder="Search for names.." class="white-text" autofocus>
							...
							<ul class="collection box" id="playercheck">
								...
								<li class="collection-item avatar white">
									...
									<div class="col s6 ">
										<h6 class="truncate">
											<span><b class="playertmrid"><%=trialMember.getFname().toUpperCase()%> <%=trialMember.getMname().toUpperCase()%>
									...
									<div class="col s4 ">
										<h6>
											<span><b class="playertmrid"><%=getmyPath.getReg_id(trialMember.getTmr_id())%></b></span>
										</h6>
									</div>
									<div class="col s2">
										<%
											if (getDAOBool.isTrialPlayerAppeared(trial_id, trialMember.getTmr_id())) {
										%>
										<input type="checkbox"
										...
										%>
										<label style="margin-top:10px;" for="myCheckbox<%=trialMember.getTmr_id()%>"></label>
 ...
 <script type="text/javascript" src="js/plugins.min.js"></script>
	<script type="text/javascript">
		...
		function isvalidForm(form) {
			...
			if (count == 1)
				{
					alert("Select First 6 player for Team A and Next 6 for Team B.");
					return false;
				}
			else
				return true;
